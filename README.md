...
Software Developer from Hong Kong | City University of Hong Kong
...
- [learn-faster-kit](https://github.com/hluaguo/learn-faster-kit) — AI-powered learning coach with spaced repetition (Python)
- [metabase-mcp](https://github.com/hluaguo/metabase-mcp) — MCP server for the Metabase API, connecting analytics to LLMs (Python)
- [commity](https://github.com/hluaguo/commity) — AI git commit message generator with TUI (Go)
- [omni-provider](https://github.com/hluaguo/omni-provider) — Small Go interface for OpenAI, Anthropic, and Gemini (Go)
- [hluaguo.com](https://github.com/hluaguo/hluaguo.com) — Personal website (Astro)
